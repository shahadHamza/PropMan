                    ...
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            <a class="side-menu__item" href="{{ url('/' . $page='') }}">
                                ...
                                </svg><span class="side-menu__label">Main</span></a>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='contracts') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">Contracts and payments</span>
                                <i class="angle fe fe-chevron-down"></i></a>
                            <ul class="slide-menu">
                                <li><a class="slide-item" href="{{ url('/' . $page='contracts/create') }}">Add contract</a></li>
                                <li><a class="slide-item" href="{{ url('/' . $page='all_contracts') }}">view contracts</a></li>
                                <li><a class="slide-item" href="{{ url('/' . $page='payment/create') }}">update payment status</a></li>
                                <li><a class="slide-item" href="{{ url('/' . $page='payment') }}">Payments</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" href="{{ url('/' . $page='maintenance') }}">
                                ...
                                <span class="side-menu__label">Maintenance request</span></a>
                        </li>
                    ...
                    @endif
                        ...
                        @if(Auth::user()->type==0)
                            <ul class="side-menu">
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='maintenance') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 4C9.24 4 7 6.24 7 9c0 2.85 2.92 7.21 5 9.88 2.11-2.69 5-7 5-9.88 0-2.76-2.24-5-5-5zm0 7.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" opacity=".3"/><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zM7 9c0-2.76 2.24-5 5-5s5 2.24 5 5c0 2.88-2.88 7.19-5 9.88C9.92 16.21 7 11.85 7 9z"/><circle cx="12" cy="9" r="2.5"/></svg><span class="side-menu__label">Maintenance request</span>
                                    <i class="angle fe fe-chevron-down"></i></a>
                                    <ul class="slide-menu">
                                        <li><a class="slide-item" href="{{ url('/' . $page='maintenance/create') }}">add maintenance request</a></li>
                                        <li><a class="slide-item" href="{{ url('/' . $page='maintenance') }}">maintenance requests</a></li>
                                    </ul>
                                </li>
                                <li class="slide">
                                    <a class="side-menu__item"  href="{{ url('/' . $page='confirmation') }}">
                                        ...
                                        <span class="side-menu__label">Rent Requests</span></a>
                                </li>
                                @endif
